...
//! the same authority model as the in-process catalog, now behind the
//! sandbox membrane. Edits it makes author as its own peer and pass the
//! grade gate, identically to a linked-in plugin.
