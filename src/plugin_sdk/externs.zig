...
pub extern "weft" fn wl_readonly_clear() void;
pub extern "weft" fn wl_readonly_span(start: u32, end: u32) void;
...
pub extern "weft" fn wl_declare_action(ptr: u32, len: u32) void;
...
pub extern "weft" fn wl_pick_add_keyed(t: u32, tl: u32, d: u32, dl: u32, k: u32, kl: u32) void;
...
pub extern "weft" fn wl_subbuffer_clear() void;
pub extern "weft" fn wl_subbuffer_fact_at(offset: u32, k: u32, kl: u32, out: u32, cap: u32) i32;
...
pub extern "weft" fn wl_semantic_active() u32;
pub extern "weft" fn wl_semantic_working_target(out: u32, out_cap: u32) i32;
...
pub extern "weft" fn wl_semantic_transfer_retain(authority: u32, slot: u32, generation: u32) i32;
pub extern "weft" fn wl_semantic_transfer_release(authority: u32, slot: u32, generation: u32) i32;
...
pub extern "weft" fn wl_env_retract() i32;
...
pub extern "weft" fn wl_fs_list_async(auth: u32, auth_len: u32, path: u32, path_len: u32, dest: u32, dest_len: u32) i32;
