...
// ── Transport + sync primitives (see session/link.zig) ──────────────

const link_mod = @import("session/link.zig");
const futexWaitTimed = link_mod.futexWaitTimed; // used by the tests below
...
const serveBase = remote_fs.serveBase; // used by Collab below
